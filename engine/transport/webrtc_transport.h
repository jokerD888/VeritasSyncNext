...
class WebRtcTransport final : public Transport {
 ...
 private:
  ...
  void* module_ = nullptr; void* factory_ = nullptr; void* send_control_ = nullptr; void* send_bulk_ = nullptr; void* destroy_ = nullptr; void* create_offer_ = nullptr; void* apply_offer_ = nullptr; void* apply_answer_ = nullptr; void* apply_ice_ = nullptr; std::mutex callback_mutex_; ReceiveCallback callback_; SdpCallback offer_callback_; SdpCallback answer_callback_; IceCallback ice_callback_;
};
}  // namespace veritassync::transport
